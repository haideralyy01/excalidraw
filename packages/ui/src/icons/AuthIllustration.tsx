    ...
    >
      ...
      <defs>
        <radialGradient id="glow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#a8a5ff" stopOpacity="0.3" />
          <stop offset="100%" stopColor="#a8a5ff" stopOpacity="0" />
        </radialGradient>
        <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#a8a5ff" />
          <stop offset="100%" stopColor="#7b78d9" />
        </linearGradient>
        <linearGradient id="grad2" x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#a8a5ff" stopOpacity="0.6" />
          <stop offset="100%" stopColor="#232329" stopOpacity="0.8" />
        </linearGradient>
      </defs>
      ...
      <rect
        ...
        fill="none"
        strokeOpacity="0.4"
        transform="rotate(15, 137, 117)"
      />

      {/* Top-right triangle */}
      <polygon
        points="350,110 370,145 330,145"
        stroke="#a8a5ff"
        strokeWidth="1.5"
        fill="none"
        strokeOpacity="0.35"
      ...
      <rect
        ...
        fillOpacity="0.08"
        strokeOpacity="0.35"
        transform="rotate(45, 359, 349)"
      />

      {/* Small dots / stars */}
      <circle cx="180" cy="160" r="3" fill="#a8a5ff" fillOpacity="0.5" />
      <circle cx="330" cy="180" r="2.5" fill="#a8a5ff" fillOpacity="0.4" />
      <circle cx="310" cy="330" r="3" fill="#a8a5ff" fillOpacity="0.3" />
      <circle cx="170" cy="300" r="2" fill="#a8a5ff" fillOpacity="0.45" />
      <circle cx="250" cy="130" r="2" fill="#a8a5ff" fillOpacity="0.35" />
      <circle cx="380" cy="260" r="2.5" fill="#a8a5ff" fillOpacity="0.25" />
      <circle cx="130" cy="240" r="2" fill="#a8a5ff" fillOpacity="0.3" />
